locals {
  mimhsprddbvm01PrivateIpAddress = data.azurerm_key_vault_secret.mimhsprddbvm01PrivateIpAddress.value

  mimhsprdappvm01PrivateIpAddress = data.azurerm_key_vault_secret.mimhsprdappvm01PrivateIpAddress.value

  mimhsprdappvm02PrivateIpAddress = data.azurerm_key_vault_secret.mimhsprdappvm02PrivateIpAddress.value
