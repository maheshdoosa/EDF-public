########### Resource Group ##################
module "genDiamondSSNetworkResourceGroup" {
...
resource "azurerm_virtual_network" "vnets" {
  ...
  depends_on          = [module.genDiamondSSNetworkResourceGroup]
...
module "genDiamondSSUdrs" {
  ...
  tags       = module.genDiamondSSUdrTable.tagsResult
...
resource "azurerm_subnet_route_table_association" "assingUDRs" {
  ...
  depends_on = [module.genDiamondSSUdrs]
}
