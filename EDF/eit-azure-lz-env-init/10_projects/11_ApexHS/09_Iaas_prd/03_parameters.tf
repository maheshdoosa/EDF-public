...
variable "ApexHsUATvmRgName" {
  description = "apexHsuatvmRgName"
  default     = ".tmp-name" //intentionally kept it to something unrealistic
  type        = string
}

variable "UATVM01nicIpConfigName" {
  description = "UATVM01nicIpConfigName"
  default     = ".tmp-loc" //intentionally kept it to something unrealistic
  type        = string
}

variable "ApexHsuatvm01nicname" {
  description = "UATVM01nicIpConfigName"
  default     = ".tmp-loc" //intentionally kept it to something unrealistic
  type        = string
}

variable "ApexHsuatvm02nicname" {
  description = "UATVM01nicIpConfigName"
  default     = ".tmp-loc" //intentionally kept it to something unrealistic
  type        = string
}

variable "UATVM02nicIpConfigName" {
  description = "UATVM02nicIpConfigName"
  default     = ".tmp-loc" //intentionally kept it to something unrealistic
  type        = string
}

variable "ApexHsuatSubnetName" {
  description = "ApexHsuatSubnetName"
  default     = ".tmp-loc" //intentionally kept it to something unrealistic
  type        = string
}
