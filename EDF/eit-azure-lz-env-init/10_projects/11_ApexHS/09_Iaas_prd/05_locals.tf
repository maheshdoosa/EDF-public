locals {
  ...
  ApexHsuatvm01PrivateIpAddress = data.azurerm_key_vault_secret.ApexHsuatvm01PrivateIpAddress.value
  ApexHsuatvm02PrivateIpAddress = data.azurerm_key_vault_secret.ApexHsuatvm02PrivateIpAddress.value
