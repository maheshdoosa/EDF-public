module "apexNetworkResourceGroup" {
...
resource "azurerm_virtual_network" "vnets" {
  ...
  depends_on          = [module.apexNetworkResourceGroup]
}
...
module "apexNetworkUdrs" {
  ...
  tags       = module.apexUdrTable.tagsResult
...
resource "azurerm_subnet_route_table_association" "assingUDRs" {
  ...
  depends_on = [module.apexNetworkUdrs]
}
