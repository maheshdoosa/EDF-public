module "morwipNetworkResourceGroup" {
...
resource "azurerm_virtual_network" "vnets" {
  ...
  depends_on          = [module.morwipNetworkResourceGroup]
}
...
module "morwipNetworkUdrs" {
  ...
  tags       = module.morwipUdrTable.tagsResult
...
resource "azurerm_subnet_route_table_association" "assingUDRs" {
  ...
  depends_on = [module.morwipNetworkUdrs]
}
