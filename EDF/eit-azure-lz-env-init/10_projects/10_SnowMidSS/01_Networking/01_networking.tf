module "sssecgovNetworkResourceGroup" {
...
resource "azurerm_virtual_network" "vnets" {
  ...
  depends_on          = [module.sssecgovNetworkResourceGroup]
}
...
module "sssecgovNetworkUdrs" {
  ...
  tags       = module.sssecgovUdrTable.tagsResult
...
resource "azurerm_subnet_route_table_association" "assingUDRs" {
  ...
  depends_on = [module.sssecgovNetworkUdrs]
}
