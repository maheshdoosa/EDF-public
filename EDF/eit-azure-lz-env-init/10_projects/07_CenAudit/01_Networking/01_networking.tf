module "cenadtNetworkResourceGroup" {
...
resource "azurerm_virtual_network" "vnets" {
  ...
  tags       = module.cenadtVnetTags.tagsResult
  depends_on = [module.cenadtNetworkResourceGroup]
}
...
module "cenadtNetworkUdrs" {
  ...
  tags       = module.cenadtUdrTable.tagsResult
...
resource "azurerm_subnet_route_table_association" "assingUDRs" {
  ...
  depends_on = [module.cenadtNetworkUdrs]
}
...
module "AzureMonitorPrivateLinkScope" {
  source = "git::ssh://git@github.com/edfenergy/eit-azure-terraform-modules.git//azure-monitor-private-linkscope?ref=v1.1.19"
  ...
  name              = var.laPrivateServiceConnName
...
module "PrivateEndPointLA" {
  ...
  depends_on                  = [azurerm_subnet.subnets, module.AzureMonitorPrivateLinkScope]
}
