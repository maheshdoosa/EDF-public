...
variable "hpbdvdbprodRgName" {
  description = "hpbdvdbprodRgName"
  default     = ".tmp-name" //intentionally kept it to something unrealistic
  type        = string
}
variable "hpbdvdbprodResourceLocation" {
  description = "hpbdvdbprodResourceLocation"
  default     = ".tmp-name" //intentionally kept it to something unrealistic
  type        = string
}
variable "hpbdvdbprodServerName" {
  description = "hpbdvdbprodServerName"
  default     = ".tmp-name" //intentionally kept it to something unrealistic
  type        = string
}
