locals {
  NuclearRnDHSdevvm01PrivateIpAddress = data.azurerm_key_vault_secret.PrivateIpAddressweb.value
  NuclearRnDHSdevvm02PrivateIpAddress = data.azurerm_key_vault_secret.PrivateIpAddressapp.value
...
PROTECTED_SETTINGS
  EncryptVMsettingsNucleardevvm01 = <<SETTINGS
    {
        ...
        SETTINGS
  EncryptVMsettingsNucleardevvm02 = <<SETTINGS
    {
        "EncryptionOperation": "${var.EncryptionOperation}",
        "KeyVaultURL": "${local.KeyVaultURL}",
        "KeyVaultResourceId": "${local.KeyVaultResourceId}",
  ...
  vm_source_id = {
    source_vm01_id      = "/subscriptions/${local.subId}/resourceGroups/${var.NuclearRnDHSdevvmRgName}/providers/Microsoft.Compute/virtualMachines/${var.NuclearRnDHSdevvm01Name}"
    source_vm02_id      = "/subscriptions/${local.subId}/resourceGroups/${var.NuclearRnDHSdevvmappRgName}/providers/Microsoft.Compute/virtualMachines/${var.NuclearRnDHSdevvm02Name}"
