...
variable "NuclearRnDHSdevvmRgName" {
  description = "NuclearRnDHSdevvmRgName"
  default     = ".tmp-name" //intentionally kept it to something unrealistic
  type        = string
}

variable "NuclearRnDHSdevvmappRgName" {
  description = "NuclearRnDHSdevvmappRgName"
  default     = ".tmp-name" //intentionally kept it to something unrealistic
  type        = string
}

variable "NuclearRnDHSdevvm01nicname" {
  description = "NuclearRnDHSdevvm01nicname"
  default     = ".tmp-loc" //intentionally kept it to something unrealistic
  type        = string
}

variable "NuclearRnDHSdevvm02nicname" {
  description = "NuclearRnDHSdevvm02nicname"
  default     = ".tmp-loc" //intentionally kept it to something unrealistic
  type        = string
}
...
variable "NuclearRnDHSdevvm01Name" {
  description = "NuclearRnDHSdevvm01Name"
  default     = ".tmp-loc" //intentionally kept it to something unrealistic
  type        = string
}

variable "NuclearRnDHSdevvm02Name" {
  description = "NuclearRnDHSdevvm02Name"
  default     = ".tmp-loc" //intentionally kept it to something unrealistic
  type        = string
}
...
variable "NuclearRnDHSdevVnetName" {
  description = "NuclearRnDHSdevVnetName"
  default     = ".tmp-loc" //intentionally kept it to something unrealistic
  type        = string
}
variable "NuclearRnDHSdevSubnetName" {
  description = "NuclearRnDHSdevSubnetName"
  default     = ".tmp-loc" //intentionally kept it to something unrealistic
  type        = string
}

variable "NuclearRnDHSdevSubnetNameapp" {
  description = "NuclearRnDHSdevSubnetName"
  default     = ".tmp-loc" //intentionally kept it to something unrealistic
  type        = string
}

variable "NuclearRnDHSdevNetworkingRgName" {
  description = "NuclearRnDHSdevNetworkingRgName"
  default     = ".tmp-loc" //intentionally kept it to something unrealistic
  type        = string
}
