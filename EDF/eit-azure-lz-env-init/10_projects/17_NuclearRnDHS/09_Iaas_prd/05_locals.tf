locals {
  NuclearRnDHSprdvm01PrivateIpAddress = data.azurerm_key_vault_secret.guksprdhshpw01IP.value
  NuclearRnDHSprdvm02PrivateIpAddress = data.azurerm_key_vault_secret.guksprdhshpa01IP.value
...
PROTECTED_SETTINGS
  EncryptVMsettingsNuclearprdvm01 = <<SETTINGS
    {
        ...
        SETTINGS
  EncryptVMsettingsNuclearprdvm02 = <<SETTINGS
    {
        "EncryptionOperation": "${var.EncryptionOperation}",
        "KeyVaultURL": "${local.KeyVaultURL}",
        "KeyVaultResourceId": "${local.KeyVaultResourceId}",
  ...
  vm_source_id = {
    source_vm01_id      = "/subscriptions/${local.subId}/resourceGroups/${var.NuclearRnDHSprdvmRgName}/providers/Microsoft.Compute/virtualMachines/${var.NuclearRnDHSprdvm01Name}"
    source_vm02_id      = "/subscriptions/${local.subId}/resourceGroups/${var.NuclearRnDHSprdvmappRgName}/providers/Microsoft.Compute/virtualMachines/${var.NuclearRnDHSprdvm02Name}"
