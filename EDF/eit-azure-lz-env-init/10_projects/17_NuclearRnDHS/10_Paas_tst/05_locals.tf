locals {
  hpbdvdSQLLinkScopeId = "/subscriptions/${local.subId}/resourceGroups/${var.hpbdvdbdevRgName}/providers/Microsoft.DBforPostgreSQL/servers/${var.hpbdvdbdevServerName}"
  subId                = data.azurerm_key_vault_secret.hpbdvdbdevSQLSubscriptionID.value
  diag_settings = {

    "hpbdvdbdevSQL-diagnostics-hs-CentralAudit" = {
    ...
    "hpbdvdbdevSQL-diagnostics-mgmt-LogWorkSpace" = {
      resource_ids     = data.azurerm_postgresql_server.hpbdvdbSqlDBserver.id
