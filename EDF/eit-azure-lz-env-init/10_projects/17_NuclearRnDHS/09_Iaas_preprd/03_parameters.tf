...
variable "NuclearRnDHSnpdvmRgName" {
  description = "NuclearRnDHSnpdvmRgName"
  default     = ".tmp-name" //intentionally kept it to something unrealistic
  type        = string
}

variable "NuclearRnDHSnpdvmappRgName" {
  description = "NuclearRnDHSnpdvmappRgName"
  default     = ".tmp-name" //intentionally kept it to something unrealistic
  type        = string
}

variable "NuclearRnDHSnpdvm01nicname" {
  description = "NuclearRnDHSnpdvm01nicname"
  default     = ".tmp-loc" //intentionally kept it to something unrealistic
  type        = string
}

variable "NuclearRnDHSnpdvm02nicname" {
  description = "NuclearRnDHSnpdvm02nicname"
  default     = ".tmp-loc" //intentionally kept it to something unrealistic
  type        = string
}
...
variable "NuclearRnDHSnpdvm01Name" {
  description = "NuclearRnDHSnpdvm01Name"
  default     = ".tmp-loc" //intentionally kept it to something unrealistic
  type        = string
}

variable "NuclearRnDHSnpdvm02Name" {
  description = "NuclearRnDHSnpdvm02Name"
  default     = ".tmp-loc" //intentionally kept it to something unrealistic
  type        = string
}
...
variable "NuclearRnDHSnpdVnetName" {
  description = "NuclearRnDHSnpdVnetName"
  default     = ".tmp-loc" //intentionally kept it to something unrealistic
  type        = string
}
variable "NuclearRnDHSnpdSubnetName" {
  description = "NuclearRnDHSnpdSubnetName"
  default     = ".tmp-loc" //intentionally kept it to something unrealistic
  type        = string
}

variable "NuclearRnDHSnpdSubnetNameapp" {
  description = "NuclearRnDHSnpdSubnetName"
  default     = ".tmp-loc" //intentionally kept it to something unrealistic
  type        = string
}

variable "NuclearRnDHSnpdNetworkingRgName" {
  description = "NuclearRnDHSnpdNetworkingRgName"
  default     = ".tmp-loc" //intentionally kept it to something unrealistic
  type        = string
}
...
variable "adAdminGroup" {
  ...
  default     = ".tmp-npd" //intentionally kept it to something unrealistic
  type        = string
}
