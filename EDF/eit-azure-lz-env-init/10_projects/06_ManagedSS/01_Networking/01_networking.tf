module "mngdssNetworkResourceGroup" {
...
resource "azurerm_virtual_network" "vnets" {
  ...
  depends_on          = [module.mngdssNetworkResourceGroup]
}
...
module "mngdssNetworkUdrs" {
  ...
  tags       = module.mngdssUdrTable.tagsResult
...
resource "azurerm_subnet_route_table_association" "assingUDRs" {
  ...
  depends_on = [module.mngdssNetworkUdrs]
}
