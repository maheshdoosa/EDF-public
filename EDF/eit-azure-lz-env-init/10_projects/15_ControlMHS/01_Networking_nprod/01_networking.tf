########### Resource Group ##################
module "controlmHSNetworkResourceGroup" {
...
resource "azurerm_virtual_network" "vnets" {
  ...
  depends_on          = [module.controlmHSNetworkResourceGroup]
...
module "controlmHSUdrs" {
  ...
  tags              = module.controlmHSUdrTable.tagsResult
...
resource "azurerm_subnet_route_table_association" "assingUDRs" {
  ...
  depends_on     = [module.controlmHSUdrs]
}
