locals {
  ControlMHsnpvm01PrivateIpAddress = data.azurerm_key_vault_secret.ControlMHsnpvm01PrivateIpAddress.value
...
PROTECTED_SETTINGS
  ...
  EncryptVMsettingsctrlmnpvm01 = <<SETTINGS
    {
  ...
  vm_source_id = {
    source_vm01_id      = "/subscriptions/${local.subId}/resourceGroups/${var.ControlMHsnpvmRgName}/providers/Microsoft.Compute/virtualMachines/${var.ControlMHsnpvm01Name}"
