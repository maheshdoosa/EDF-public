...
variable "ControlMHsnpvmRgName" {
  description = "controlMHsnpvmRgName"
...
variable "ControlMHsnpvm01nicname" {
  description = "controlMHsnpvm01nicname"
  default     = ".tmp-loc" //intentionally kept it to something unrealistic
  type        = string
}
...
variable "ControlMHsnpvm01Name" {
  description = "ControlMHsnpvm01Name"
  default     = ".tmp-loc" //intentionally kept it to something unrealistic
  type        = string
}
######### golden image #####
...
variable "ControlMHsnpVnetName" {
  description = "ControlMHsnpVnetName"
  default     = ".tmp-loc" //intentionally kept it to something unrealistic
  type        = string
}
variable "ControlMHsnpSubnetName" {
  description = "ControlMHsnpSubnetName"
  default     = ".tmp-loc" //intentionally kept it to something unrealistic
  type        = string
}
variable "ControlMHsnpNetworkingRgName" {
  description = "ControlMHsnpNetworkingRgName"
  default     = ".tmp-loc" //intentionally kept it to something unrealistic
  type        = string
}
...
############## VM02 #######
# variable "ControlMHsnpvm02nicname" {
#   description = "controlMHsnpvm02nicname"
#   default     = ".tmp-loc" //intentionally kept it to something unrealistic
#   type        = string
# }
...
#   type        = string
# }
# variable "ControlMHsnpvm02Name" {
#   description = "ControlMHsnpvm02Name"
#   default     = ".tmp-loc" //intentionally kept it to something unrealistic
#   type        = string
# }
