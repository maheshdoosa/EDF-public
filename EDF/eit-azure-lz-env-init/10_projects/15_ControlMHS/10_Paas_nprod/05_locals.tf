locals {
  ...
  diag_settings = {
    ...
    "ControlM-NonProd-rsv-diagnostics-hs-CentralAudit" = {
    ...
    "ControlM-NonProd-rsv-diagnostics-mgmt-LogWorkSpace" = {
      resource_ids     = module.az-recoveryservicevault.recovery_services_vault.id
...
locals {
  ...
  sa_diag_settings = {
    "cntrlmHSvmDiagsa-hs-law" = {
      resource_ids     = "${data.azurerm_storage_account.cntrlmHSvmDiagsa.id}/blobServices/default/"
      law_workspace_id = data.azurerm_key_vault_secret.laworkspaceId02.value
      diagnostic_log = [
        {
    ...
    "cntrlmHSauxsa-hs-law" = {
      resource_ids     = "${data.azurerm_storage_account.cntrlmHSauxsa.id}/blobServices/default/"
      law_workspace_id = data.azurerm_key_vault_secret.laworkspaceId02.value
      diagnostic_log = [
        {
          category = var.category19
