...
module "createTargetRgForComsySQLPaaS" {
  ...
  resourceLocation  = var.comsySQLPaaSResourceLocation
...
module "CreateGenPrdManagedTSTSqlPaaSServer" {
  ...
  sqlServerPrimaryLocation              = var.comsySQLPaaSResourceLocation
...
module "PrivateEndPointComsySQL" {
  ...
  endPointLocation            = var.comsySQLPaaSResourceLocation
