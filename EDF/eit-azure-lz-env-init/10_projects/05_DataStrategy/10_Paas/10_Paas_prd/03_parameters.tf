...
variable "MDWHsPrdVmLogsRgName" {
  description = "MDWHsPrdVmLogsRgName"
  default     = ".tmp-name" //intentionally kept it to something unrealistic
  type        = string
}

variable "vmDiagPrdSA" {
  description = "vmDiagSA"
  default     = ".tmp-loc" //intentionally kept it to something unrealistic
  type        = string
}

variable "MDWHsUatVmLogsRgName" {
  description = "MDWHsUatVmLogsRgName"
  default     = ".tmp-name" //intentionally kept it to something unrealistic
  type        = string
}

variable "vmDiagUatSA" {
  description = "vmDiagSA"
  default     = ".tmp-loc" //intentionally kept it to something unrealistic
  type        = string
}
...
variable "MDWHs_infraVM_backup_policy_01" {
  description = "MDWHsPrd_infraVM_backup_policy_01"
  default     = ".tmp-rg" //intentionally kept it to something unrealistic
  type        = string
}

variable "MDWHs_infraVM_backup_policy_02" {
  description = "MDWHsPrd_infraVM_backup_policy_02"
  default     = ".tmp-rg" //intentionally kept it to something unrealistic
  type        = string
}
...
variable "MDWHsPrdkvRgName" {
  description = "MDWHsPrdkvRgName"
  default     = ".tmp-sa" //intentionally kept it to something unrealistic
  type        = string
}

variable "MDWHsPrdkvName" {
  description = "MDWHsPrdkvName"
  default     = ".tmp-sa" //intentionally kept it to something unrealistic
  type        = string
}

variable "MDWHsUatkvRgName" {
  description = "MDWHsUatkvRgName"
  default     = ".tmp-sa" //intentionally kept it to something unrealistic
  type        = string
}

variable "MDWHsUatkvName" {
  description = "MDWHsUatkvName"
  default     = ".tmp-sa" //intentionally kept it to something unrealistic
  type        = string
}
...
variable "MDWHs_Prd_endpoint_name" {
...
variable "MDWHs_Uat_endpoint_SC" {
  description = "Prod privite end point name Service connection name"
  default     = ".tmp-sa" //intentionally kept it to something unrealistic
  type        = string
}
...
variable "dataprdSubnetName" {
  description = "dataprdSubnetName"
  default     = ".tmp-sa" //intentionally kept it to something unrealistic
  type        = string
}
variable "dataprdVnetName" {
  description = "dataprdVnetName"
  default     = ".tmp-sa" //intentionally kept it to something unrealistic
  type        = string
}
variable "dataprdNetworkingRgName" {
  description = "dataprdNetworkingRgName"
  default     = ".tmp-sa" //intentionally kept it to something unrealistic
  type        = string
}
