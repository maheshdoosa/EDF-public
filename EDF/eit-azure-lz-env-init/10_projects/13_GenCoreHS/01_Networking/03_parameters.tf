...
#hssecgov key vault
variable "gencoreKvName" {
  description = "gencoreKvName"
  default     = ".tmp-name" //intentionally kept it to something unrealistic
  type        = string
}

variable "gencoreKvRgName" {
  description = "gencoreKvRgName"
  default     = ".tmp-name" //intentionally kept it to something unrealistic
  type        = string
}
...
variable "asg" {
  type        = map(any)
  description = "Key-Vaule Pairs. Key is ASG name and Value is a map of NSG details"
  default     = {}
}
...
variable "av_nsg_name" {
  default = ""
  type    = string
}

variable "sccm_nsg_name" {
  default = ""
  type    = string
}
...
variable "tmr_nsg_name" {
  default = ""
  type    = string
}
variable "pep02_nsg_name" {
  default = ""
  type    = string
}
