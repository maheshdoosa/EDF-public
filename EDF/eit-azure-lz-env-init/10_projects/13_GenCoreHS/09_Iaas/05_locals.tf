...
locals {
  ...
  tmr01PrivateIpAddress     = data.azurerm_key_vault_secret.tmr01PrivateIpAddress.value
  tmr02PrivateIpAddress     = data.azurerm_key_vault_secret.tmr02PrivateIpAddress.value
  ...
  KeyEncryptionKeyURLstmr01 = data.azurerm_key_vault_secret.tmr01EncryptKeyURL.value

  KeyEncryptionKeyURLstmr02 = data.azurerm_key_vault_secret.tmr02EncryptKeyURL.value
...
locals {
  ...
  SETTINGS
  EncryptVMsettingstmr01     = <<SETTINGS
    {
        "EncryptionOperation": "${var.EncryptionOperation}",
        "KeyVaultURL": "${local.KeyVaultURL}",
        "KeyVaultResourceId": "${local.KeyVaultResourceId}",
        "KekVaultResourceId": "${local.KekVaultResourceId}",
        "KeyEncryptionKeyURL": "${local.KeyEncryptionKeyURLstmr01}",
        "KeyEncryptionAlgorithm": "${var.KeyEncryptionAlgorithm}",
        "VolumeType": "${var.VolumeType}"
    }
  SETTINGS
  EncryptVMsettingstmr02     = <<SETTINGS
    {
        "EncryptionOperation": "${var.EncryptionOperation}",
        "KeyVaultURL": "${local.KeyVaultURL}",
        "KeyVaultResourceId": "${local.KeyVaultResourceId}",
        "KekVaultResourceId": "${local.KekVaultResourceId}",
        "KeyEncryptionKeyURL": "${local.KeyEncryptionKeyURLstmr02}",
        "KeyEncryptionAlgorithm": "${var.KeyEncryptionAlgorithm}",
        "VolumeType": "${var.VolumeType}"
    }
  SETTINGS
...
locals {
  ...
  vm_source_id = {
    ...
    source_trmvm_id01 = "/subscriptions/${local.subId}/resourceGroups/${var.lztmrVmRgName}/providers/Microsoft.Compute/virtualMachines/${var.tmr01vmName}"
    source_trmvm_id02 = "/subscriptions/${local.subId}/resourceGroups/${var.lztmrVmRgName}/providers/Microsoft.Compute/virtualMachines/${var.tmr01vmName}"
