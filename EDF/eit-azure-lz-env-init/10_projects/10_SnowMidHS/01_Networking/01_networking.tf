module "hssecgovNetworkResourceGroup" {
...
resource "azurerm_virtual_network" "vnets" {
  ...
  depends_on          = [module.hssecgovNetworkResourceGroup]
}
...
module "hssecgovNetworkUdrs" {
  ...
  tags       = module.hssecgovUdrTable.tagsResult
...
resource "azurerm_subnet_route_table_association" "assingUDRs" {
  ...
  depends_on = [module.hssecgovNetworkUdrs]
}
