...
#hssecgov key vault
variable "hssecgovKvName" {
  description = "hssecgovKvName"
  default     = ".tmp-name" //intentionally kept it to something unrealistic
  type        = string
}

variable "hssecgovKvRgName" {
  description = "hssecgovKvRgName"
  default     = ".tmp-name" //intentionally kept it to something unrealistic
  type        = string
}
...
variable "pentest_nsg_name" {
  default = ""
  type    = string
}

variable "tenable_nsg_name" {
  default = ""
  type    = string
}
