locals {
  ...
  diag_settings = {
    ...
    "SnowMid-rsv-diagnostics-hs-CentralAudit" = {
    ...
    "SnowMid-rsv-diagnostics-mgmt-LogWorkSpace" = {
      resource_ids     = module.az-recoveryservicevault.recovery_services_vault.id
...
locals {
  ...
  sa_diag_settings = {
    "auxsa-hs-law" = {
      resource_ids     = "${data.azurerm_storage_account.secgovHSauxsa.id}/blobServices/default/"
      law_workspace_id = data.azurerm_key_vault_secret.laworkspaceId02.value
      diagnostic_log = [
        {
    ...
    "vmDiagsa-hs-law" = {
      resource_ids     = "${data.azurerm_storage_account.secgovHSvmDiagsa.id}/blobServices/default/"
      law_workspace_id = data.azurerm_key_vault_secret.laworkspaceId02.value
      diagnostic_log = [
        {
          category = var.category16
