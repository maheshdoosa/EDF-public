...
data "azurerm_network_security_group" "testa_nsg" {
  name                = var.testa_nsg_name
...
data "azurerm_network_security_group" "testb_nsg" {
  name                = var.testb_nsg_name
  resource_group_name = var.nsg_rg_name
}

data "azurerm_network_security_group" "replicate_nsg" {
  name                = var.replicate_nsg_name
  resource_group_name = var.nsg_rg_name
}
...
data "azurerm_virtual_network" "gendiastghs_vnet" {
