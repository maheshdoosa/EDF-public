environment    = "Staging"
cenadtKvName   = "eaminfrasecrets"
cenadtKvRgName = ".security"
cenadtAgRgName = "eit-uks-stg-laws-security-rg-01" // LA workspace RG name
...
# cenadtKvRgName          = ".security"
# cenadtAgRgName          = "eit-uks-stg-update-rg" // LA workspace RG name

#################################################

cenadtResourceLocation  = "UK South"
cenadtAgName            = "edf_eit_SecurityOps_testonly"
...
emails = [
  {
    ...
    email_address           = "netra.lal.bhushal@accenture.com"
