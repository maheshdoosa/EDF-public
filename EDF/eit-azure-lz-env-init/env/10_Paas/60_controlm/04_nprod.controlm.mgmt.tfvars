...
resourceGroupName            = "eit-uks-np-hs-vmbackup-rg"
sku                          = "Standard"
...
#########  SA VMdiag #######
controlmHSVmLogsRgName       = "eit-uks-np-hs-vmlogs-rg-01"
controlmHSResourceLocation   = "uksouth"
vmDiagSA                     = "eituksnpmngdvmlogssa01"
...
keyvault_name                   = "eit-uks-np-hs-ade-kv-01"
resource_Location               = "uk south"
kv_resource_group_name          = "eit-uks-np-hs-ade-rg-01"
...
endpoint_name                   = "eithsctrlmnpkvt-pe"
endpoint_SC                     = "eithsctrlmnpkvt-pesc"
is_manual_connection            = "false" //keep default false
subresource_names               = ["vault"]
lzsandpitNetworkingRgName       = "eit-uks-np-hs-mngd-vnet-rg-01"
lzsandpitVnetName               = "eit-uks-np-hs-mngd-vnet-01"
peSubnetName                    = "eit-uks-np-hs-pep-snet-01"
aad_group                       = "EIT-NP-RBAC-HS-EITManaged-Contributor"
aad_user                        = "SVL-AZ-Wayne.Crow@edfenergynnb.onmicrosoft.com"

##### Control M aux SA ############
cntrlmHSsaRgName               = "eit-uks-np-hs-auxscripts-rg-01"
cntrlmHSsaResourceLocation     = "uksouth"
cntrlmHSsa                     = "eitnpmngdauxscript"
ctrlmauxsac                    = "scripts"
...
cntrlmHSsa_publicaccess        = "false" // updated
...
cntrlmHSauxsa_endpoint_name     = "eitnpmngdauxscript-pe"
cntrlmHSauxsa_endpoint_SC       = "eitnpmngdauxscript-pesc"
cntrlmHSauxsa_subresource_names = ["blob"]
cntrlmHSpesubnetName            = "eit-uks-np-hs-pep-snet-01"
cntrlmHSVnetName                = "eit-uks-np-hs-mngd-vnet-01"
cntrlmHSNetworkingRgName        = "eit-uks-np-hs-mngd-vnet-rg-01"
cntrlmHSvmDiagsa_endpoint_name  = "eituksnpmngdvmlogssa01-pe"
cntrlmHSvmDiagsa_endpoint_SC    = "eituksnpmngdvmlogssa01-pesc"
