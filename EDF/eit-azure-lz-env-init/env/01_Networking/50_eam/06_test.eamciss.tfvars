...
#EamCISS key vault
eamCISsKvName   = "avmgentstsscisub01kv"
...
vnets = {
  gen-uks-tst-ss-ci-vnet-01 = {
    ...
    subnets = {
      ...
      gen-uks-tst-ss-ci-pep-snet-01 = {
        enable                    = true
        address                   = "gen-tst-ss-ci-pep-snet-address-range"
        enablePrivateLinkEndPoint = true
        enablePrivateLinkService  = true
      }
    }
...
spokeSubscriptionId = "eam-tst-ss-ci-SubscriptionId"
...
########################### UDRs,Routes ###############################
UDR = {
  gen-uks-tst-ss-ci-ag-udr-01 = {
    enable                = true
    RouteNames            = ["s_gen-uks-tst-ss-ci-ag-snet-d_On-Prem-Internet", "s_gen-uks-tst-ss-ci-ag-snet-d_eit-uks-alz-t2-mgmt-snet", "s_gen-uks-tst-ss-ci-ag-snet-d_eit-uks-alz-t1-snet", "s_gen-uks-tst-ss-ci-ag-snet-d_eit-uks-alz-ss-mgmt-vnet", "s_gen-uks-tst-ss-ci-law-snet-01-d_NTP_Internet"]
    NextHopTypes          = ["VirtualAppliance", "None", "None", "None", "VirtualAppliance"]
    VNetName              = "gen-uks-tst-ss-ci-vnet-01"
    RGName                = "gen-uks-tst-ss-ci-vnet-rg-01"
    kv_secret_udrprefixes = "eam-udr-prefixes"
    kv_secret_nexthopIP   = "eam-udr-nexthop"
  },
  gen-uks-tst-ss-ci-pep-udr-01 = {
    enable                = true
    RouteNames            = ["s_gen-uks-tst-ss-ci-pep-snet-d_On-Prem-Internet"]
...
UDR_Subnet_Mapping = {
  gen-uks-tst-ss-ci-ag-udr-01  = ["gen-uks-tst-ss-ci-law-snet-01"]
  gen-uks-tst-ss-ci-pep-udr-01 = ["gen-uks-tst-ss-ci-pep-snet-01"]
...
#################### NSG ################
nsg = {
  gen-uks-tst-ss-ci-pep-nsg-01 = {
    enable   = true
    location = "UK South"
    rg       = "gen-uks-tst-ss-ci-vnet-rg-01"
  },
  gen-uks-tst-ss-ci-law-nsg-01 = {
    enable   = true
    location = "UK South"
    rg       = "gen-uks-tst-ss-ci-vnet-rg-01"
  }
  ...
  gen-uks-tst-ss-ci-pep-nsg-01 = [
    {
      ...
      destination_address_prefix                 = "gen-tst-ss-ci-pep-snet-address-range"
    ...
    },
    {
      ...
      protocol                                   = "tcp"
      source_port_range                          = "*"
      source_address_prefix                      = "eam-ci-law-subnet-address-range"
      source_address_prefixes                    = ""
      destination_address_prefixes               = ""
      destination_address_prefix                 = "gen-tst-ss-ci-pep-snet-address-range"
      source_application_security_group_ids      = ""
    ...
    },
    {
      ...
      source_port_range                          = "*"
      source_address_prefix                      = "gen-tst-ss-ci-pep-snet-address-range"
      source_address_prefixes                    = ""
      destination_address_prefixes               = ""
...
nsg_subnet_mapping = {
  gen-uks-tst-ss-ci-pep-nsg-01 = {
    gen-uks-tst-ss-ci-pep-snet-01 = true
  }
  gen-uks-tst-ss-ci-law-nsg-01 = {
    gen-uks-tst-ss-ci-law-snet-01 = true
  }
}
