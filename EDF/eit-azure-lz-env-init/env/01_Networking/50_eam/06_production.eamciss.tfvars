...
#EamCI key vault
eamCISsKvName   = "avmgenprdsscisub01kv"
eamCISsKvRgName = ".security"

rgs = {
  gen-uks-prd-ss-ci-vnet-rg-01 = {
    enable   = true
    location = "UK South"
    tags = {
      environment = "Test"
...
vnets = {
  gen-uks-prd-ss-ci-vnet-01 = {
    enable        = true
    rg            = "gen-uks-prd-ss-ci-vnet-rg-01"
    addressSpace  = "eam-prd-ss-ci-vnet-addressrange"
    dnsServerList = "eam-dns-ips" // Ip has been updated based on Private DNS Config
    subnets = {
      gen-uks-prd-ss-ci-law-snet-01 = {
        enable                    = true
        address                   = "eam-prd-ss-ci-law-subnet-addressrange"
        enablePrivateLinkEndPoint = true
        enablePrivateLinkService  = true
      },
      gen-uks-prd-ss-ci-pep-snet-01 = {
        enable                    = true
        address                   = "gen-prd-ss-ci-pep-snet-address-range"
        enablePrivateLinkEndPoint = true
        enablePrivateLinkService  = true
      }
    }
...
vnet_peering = {
  peer-hub-spoke = {
    enable    = true
    peer1name = "eit-uks-alz-transit-vnet-01-gen-uks-prd-ss-ci-vnet-01"
    peer2name = "gen-uks-prd-ss-ci-vnet-01-eit-uks-alz-transit-vnet-01"
    vnet2name = "gen-uks-prd-ss-ci-vnet-01"
    vnet2rg   = "gen-uks-prd-ss-ci-vnet-rg-01"
...
spokeSubscriptionId = "eam-prd-ss-ci-SubscriptionId"
...
########################### UDRs,Routes ###############################
UDR = {
  gen-uks-prd-ss-ci-ag-udr-01 = {
    enable                = true
    RouteNames            = ["s_gen-uks-prd-ss-ci-ag-snet-d_On-Prem-Internet", "s_gen-uks-prd-ss-ci-ag-snet-d_eit-uks-alz-t2-mgmt-snet", "s_gen-uks-prd-ss-ci-ag-snet-d_eit-uks-alz-t1-snet", "s_gen-uks-prd-ss-ci-ag-snet-d_eit-uks-alz-ss-mgmt-vnet", "s_gen-uks-prd-ss-ci-law-snet-01-d_NTP_Internet"]
    NextHopTypes          = ["VirtualAppliance", "None", "None", "None", "VirtualAppliance"]
    VNetName              = "gen-uks-prd-ss-ci-vnet-01"
    RGName                = "gen-uks-prd-ss-ci-vnet-rg-01"
    kv_secret_udrprefixes = "eam-udr-prefixes"
    kv_secret_nexthopIP   = "eam-udr-nexthop"
  },
  gen-uks-prd-ss-ci-pep-udr-01 = {
    enable                = true
    RouteNames            = ["s_gen-uks-prd-ss-ci-pep-snet-d_On-Prem-Internet"]
    NextHopTypes          = ["VirtualAppliance"]
    VNetName              = "gen-uks-prd-ss-ci-vnet-01"
    RGName                = "gen-uks-prd-ss-ci-vnet-rg-01"
    kv_secret_udrprefixes = "eam-pep-udr-prefixes"
    kv_secret_nexthopIP   = "eam-pep-udr-nexthop"
  }
...
UDR_Subnet_Mapping = {
  gen-uks-prd-ss-ci-ag-udr-01  = ["gen-uks-prd-ss-ci-law-snet-01"]
  gen-uks-prd-ss-ci-pep-udr-01 = ["gen-uks-prd-ss-ci-pep-snet-01"]
...
#################### NSG ################
nsg = {
  gen-uks-prd-ss-ci-pep-nsg-01 = {
    enable   = true
    location = "UK South"
    rg       = "gen-uks-prd-ss-ci-vnet-rg-01"
  },
  gen-uks-prd-ss-ci-law-nsg-01 = {
    enable   = true
    location = "UK South"
    rg       = "gen-uks-prd-ss-ci-vnet-rg-01"
  }
  ...
  gen-uks-prd-ss-ci-pep-nsg-01 = [
    {
      ...
      destination_address_prefix                 = "gen-prd-ss-ci-pep-snet-address-range"
    ...
    },
    {
      ...
      priority                                   = "910"
      name                                       = "AIT-LAW-PEP"
      description                                = "AIT-LAW-PEP"
      destination_port_range                     = "443,445"
      protocol                                   = "tcp"
      source_port_range                          = "*"
      source_address_prefix                      = "eam-prd-ss-ci-law-subnet-addressrange"
      source_address_prefixes                    = ""
      destination_address_prefixes               = ""
      destination_address_prefix                 = "gen-prd-ss-ci-pep-snet-address-range"
      source_application_security_group_ids      = ""
    ...
    },
    {
      ...
      source_port_range                          = "*"
      source_address_prefix                      = "gen-prd-ss-ci-pep-snet-address-range"
      source_address_prefixes                    = ""
      destination_address_prefixes               = ""
...
nsg_subnet_mapping = {
  gen-uks-prd-ss-ci-pep-nsg-01 = {
    gen-uks-prd-ss-ci-pep-snet-01 = true
  }
  gen-uks-prd-ss-ci-law-nsg-01 = {
    gen-uks-prd-ss-ci-law-snet-01 = true
  }
}
