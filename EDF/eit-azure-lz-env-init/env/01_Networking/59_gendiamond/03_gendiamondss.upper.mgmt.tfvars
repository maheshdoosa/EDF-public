environment = "Standard Secured Upper"

#gendiamondss key vault
gendiamondssKvName   = "avmgenuprsswkloadsub01kv"
gendiamondssKvRgName = ".security"

###########################################################################

rgs = {
  gen-uks-upr-ss-wkload-vnet-rg-01 = {
    enable   = true
    location = "UK South"
    tags = {
      environment = "Standard Secured Upper"
...
vnets = {
  gen-uks-upr-ss-wkload-vnet-01 = {
    enable        = true
    rg            = "gen-uks-upr-ss-wkload-vnet-rg-01"
    addressSpace  = "gen-uks-upr-ss-vnet-address-range" //key vault secret name as value
    dnsServerList = "gen-uks-upr-ss-vnet-dns-ips"       //key vault secret name as value
    subnets = {
      gen-uks-upr-ss-replicate-snet-01 = {
        enable                    = true
        address                   = "gen-uks-upr-ss-rep-snet-address-range" //key vault secret name as value
        enablePrivateLinkEndPoint = true
        enablePrivateLinkService  = true
      },
      gen-uks-prd-ss-pads-snet-01 = {
        enable                    = true
        address                   = "gen-uks-prd-ss-pads-snet-address-range" //key vault secret name as value
        enablePrivateLinkEndPoint = true
        enablePrivateLinkService  = true
      },
      AzureBastionSubnet = {
        enable                    = true
        address                   = "azbastion-upr-ss-snet-address-range" //key vault secret name as value
        enablePrivateLinkEndPoint = true
        enablePrivateLinkService  = true
      },
      gen-uks-prd-ss-pep-snet-01 = {
        enable                    = true
        address                   = "gen-uks-upr-ss-pep-snet-address-range" //key vault secret name as value
        enablePrivateLinkEndPoint = true
        enablePrivateLinkService  = true
      }
    }
...
########### UDR #######################
UDR = {
  gen-uks-upr-ss-replicate-udr-01 = {
    enable                = true
    RouteNames            = ["s_gen-uks-upr-ss-replicate-snet-01-d_On-Prem-Internet", "s_gen-uks-upr-ss-replicate-snet-01-d_NTP_Internet"]
    NextHopTypes          = ["VirtualAppliance", "VirtualAppliance"]
    VNetName              = "gen-uks-upr-ss-wkload-vnet-01"
    RGName                = "gen-uks-upr-ss-wkload-vnet-rg-01"
  ...
  gen-uks-prd-ss-pads-udr-01 = {
    enable                = true
    RouteNames            = ["s_gen-uks-prd-ss-pads-snet-01-d_On-Prem-Internet", "s_gen-uks-prd-ss-pads-snet-01-d_NTP_Internet"]
    NextHopTypes          = ["VirtualAppliance", "VirtualAppliance"]
    VNetName              = "gen-uks-upr-ss-wkload-vnet-01"
    RGName                = "gen-uks-upr-ss-wkload-vnet-rg-01"
    kv_secret_udrprefixes = "gendiamondss-udr-prefixes" //key vault secret name as value
  ...
  gen-uks-upr-ss-pep-udr-01 = {
    enable                = true
    RouteNames            = ["s_gen-uks-upr-ss-pep-snet-01-d_On-Prem-Internet"]
...
UDR_Subnet_Mapping = {
  gen-uks-upr-ss-replicate-udr-01 = ["gen-uks-upr-ss-replicate-snet-01"]
  gen-uks-prd-ss-pads-udr-01      = ["gen-uks-prd-ss-pads-snet-01"]
  gen-uks-upr-ss-pep-udr-01       = ["gen-uks-prd-ss-pep-snet-01"]
}
...
nsg = {
  ...
  gen-uks-prd-ss-replicate-nsg-01 = {
    enable   = true
    location = "UK South"
    rg       = "gen-uks-upr-ss-wkload-vnet-rg-01"
  },
  gen-uks-prd-ss-pads-nsg-01 = {
    enable   = true
    location = "UK South"
    rg       = "gen-uks-upr-ss-wkload-vnet-rg-01"
  }
  ...
  gen-uks-prd-ss-pep-nsg-01 = [
    {
      ...
      destination_address_prefix                 = "gen-uks-upr-ss-pep-snet-address-range"
    ...
    },
    {
      ...
      protocol                                   = "tcp"
      source_port_range                          = "*"
      source_address_prefix                      = "gen-uks-upr-ss-rep-snet-address-range"
      source_address_prefixes                    = ""
      destination_address_prefixes               = ""
      destination_address_prefix                 = "gen-uks-upr-ss-pep-snet-address-range"
      source_application_security_group_ids      = ""
    ...
    },
    {
      ...
      source_port_range                          = "*"
      source_address_prefix                      = "gen-uks-upr-ss-pep-snet-address-range"
      source_address_prefixes                    = ""
      destination_address_prefixes               = ""
  ...
  gen-uks-prd-ss-pads-nsg-01 = [
    {
      ...
      priority                                   = "100"
      name                                       = "AOT-PADS-PEP"
      description                                = "AOT-PADS-PEP"
      destination_port_range                     = "443,445"
      protocol                                   = "tcp"
      source_port_range                          = "*"
      source_address_prefix                      = "gen-uks-prd-ss-pads-snet-address-range"
      source_address_prefixes                    = ""
      destination_address_prefixes               = ""
      destination_address_prefix                 = "gen-uks-upr-ss-pep-snet-address-range"
      source_application_security_group_ids      = ""
...
nsg_subnet_mapping = {
  ...
  gen-uks-prd-ss-replicate-nsg-01 = {
    gen-uks-upr-ss-replicate-snet-01 = true
  },
  gen-uks-prd-ss-pads-nsg-01 = {
    gen-uks-prd-ss-pads-snet-01 = true
  }
}
...
vnet_peering = {
  peer-hub-spoke = {
    enable    = true
    peer1name = "eit-uks-alz-transit-vnet-01-gen-uks-upr-ss-wkload-vnet-01"
    peer2name = "gen-uks-upr-ss-wkload-vnet-01-eit-uks-alz-transit-vnet-01"
    vnet1rg   = "eit-uks-alz-transit-vnet-rg"      //hub network resource group
    vnet1name = "eit-uks-alz-transit-vnet-01"      //hub network
    vnet2rg   = "gen-uks-upr-ss-wkload-vnet-rg-01" //spoke network resource group
    vnet2name = "gen-uks-upr-ss-wkload-vnet-01"    //spoke network
  },
  peer-hub-spoke-01 = {
    enable    = false //dummy
