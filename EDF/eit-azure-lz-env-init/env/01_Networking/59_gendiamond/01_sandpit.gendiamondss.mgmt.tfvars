...
gendiamondssKvName   = "emersonvmtest"
...
#       AzureBastionSubnet = {
#         enable                    = true
#         address                   = "azbastion-upr-snet-address-range" //key vault secret name as value
#         enablePrivateLinkEndPoint = true
#         enablePrivateLinkService  = true
#       }
...
#     enable                = true
#     RouteNames            = ["s_gen-uks-upr-ss-replicate-snet-01-d_On-Prem-Internet"]
...
#     enable                = true
#     RouteNames            = ["s_gen-uks-prd-ss-pads-snet-01-d_On-Prem-Internet"]
#     NextHopTypes          = ["VirtualAppliance"]
#     VNetName              = "gen-uks-upr-ss-wkload-vnet-01"
#     RGName                = "gen-uks-upr-ss-wkload-vnet-rg-01"
#     kv_secret_udrprefixes = "gendiamondss-udr-prefixes" //key vault secret name as value
...
vnets = {
  gen-uks-lwr-ss-wkload-vnet-01 = {
    ...
    subnets = {
      ...
      AzureBastionSubnet = {
        enable                    = true
        address                   = "azbastion-snet-address-range" //key vault secret name as value
        enablePrivateLinkEndPoint = true
        enablePrivateLinkService  = true
      },
...
UDR = {
  gen-uks-lwr-ss-replicate-udr-01 = {
    enable                = true
    RouteNames            = ["s_gen-uks-lwr-ss-replicate-snet-01-d_On-Prem-Internet"]
    NextHopTypes          = ["VirtualAppliance"]
