...
PrepVMsettings                  = <<SETTINGS
  {
      "fileUris": ["https://eituksalzssauxscriptprd.blob.core.windows.net/scripts/GBRegion.xml","https://eituksalzssauxscriptprd.blob.core.windows.net/scripts/PrepareVMForAD.ps1"]
  }
  SETTINGS
...
scriptPathPrepareVm             = "https://eituksalzssauxscriptprd.blob.core.windows.net/scripts/PrepareVMForAD.ps1"
scriptFilePrepareVm             = "PrepareVMForAD.ps1"
urlCreateAdRootDc1              = "https://eituksalzssauxscriptprd.blob.core.windows.net/scripts/CreateADRootDC1.ps1.zip"
urlConfigureADNextDC            = "https://eituksalzssauxscriptprd.blob.core.windows.net/scripts/ConfigureADNextDC.ps1.zip"
