...
PrepVMsettings                  = <<SETTINGS
  {
      "fileUris": ["https://eituksalzssauxscript.blob.core.windows.net/scripts/GBRegion.xml","https://eituksalzssauxscript.blob.core.windows.net/scripts/PrepareVMForAD.ps1"]
  }
  SETTINGS
resourceGroupName               = "eit-uks-alz-ss-adds-rg"
managementSsKvName              = "az-lz-test-mgmt-ss"
managementSsKvRgName            = ".security"
managementSsSaRgName            = "eit-uk-alz-ss-auxscripts" // to be changed from hs to ss
publisher                       = "Microsoft.Compute"
scriptPathPrepareVm             = "https://eituksalzssauxscript.blob.core.windows.net/scripts/PrepareVMForAD.ps1"
scriptFilePrepareVm             = "PrepareVMForAD.ps1"
urlCreateAdRootDc1              = "https://eituksalzssauxscript.blob.core.windows.net/scripts/CreateADRootDC1.ps1.zip"
urlConfigureADNextDC            = "https://eituksalzssauxscript.blob.core.windows.net/scripts/ConfigureADNextDC.ps1.zip"
storageAccountName              = "eituksalzssauxscript" // to be changed from hs to ss
...
addsSubnetName                  = "eit-alz-ss-adds-snet-01" // to be changed from hs to ss
