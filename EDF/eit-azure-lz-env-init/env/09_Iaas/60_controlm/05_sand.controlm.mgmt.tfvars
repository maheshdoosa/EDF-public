...
ControlMHssandvmRgName            = "eit-uks-san-hs-ctrlm-rg-01"
ControlMHsResourceLocation        = "uksouth"
ControlMHssandvm01nicname         = "eitukhssancagt1-nic-01"
enable_nic_ip_forwarding          = "false"
enable_nic_accelerated_networking = "true"
VM01nicIpConfigName               = "eitukhssancagt1-nic-01-Ip-Config"
ControlMHssandvm01Name            = "eitukhssancagt1"
ControlMHsvm01osDiskName          = "eitukhssancagt1-osdisk"
...
ImageVersion     = "Latest"
#####
ControlMHssandSubnetName       = "eit-uks-np-hs-ctrlm-snet-01"
ControlMHssandVnetName         = "eit-uks-np-hs-mngd-vnet-01"
ControlMHssandNetworkingRgName = "eit-uks-np-hs-mngd-vnet-rg-01"
...
hostname = "eitukhssancagt1.edf-hs.com"
## RSV and Backup #############
...
caching                    = "None"
disk_lun_01                = "1"
ctrlmpecvm01_data_disk     = "eitukhssancagt1-datadisk1"
pecvmdisks = {
  "disk01" = {
    pecvm01diskname = "eitukhssancagt1-datadisk1"
    pecvmrgName     = "eit-uks-san-hs-ctrlm-rg-01"
    pecdiskSize     = "256"
    pecvm01zone     = ["1"]
  }
}
diagsettingnic = [
  {
    nicname = "eitukhssancagt1-nic-01",
    rg      = "eit-uks-san-hs-ctrlm-rg-01"
  }
]
