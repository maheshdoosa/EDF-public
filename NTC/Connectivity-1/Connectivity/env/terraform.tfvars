  ...
  "uksouth" = {
        ...
        route_tables = [
          { 
            ...
            routes = [
              ...
              {
                route_name             = "routeToHubEUN"
                address_prefix         = "10.164.0.0/24"
                next_hop_type          = "VirtualAppliance"
                next_hop_in_ip_address = "10.164.0.4"
              }
            ]
          },
          { 
    ...
    virtual_network_peerings = [
      ...
      },
      {
        ...
        spoke_virtual_network_resource_group_name  = "rg-hub-cpl-cn-uks-01"
        spoke_virtual_network_name                 = "vnet-hub-cpl-cn-uks-01"
        hub_subscription_id                        = "aa2950c5-4c1e-41b7-ad10-38537bf033b1"
        hub_virtual_network_resource_group_name    = "rg-hub-cpl-cn-eun-01"
        hub_virtual_network_name                   = "vnet-hub-cpl-cn-eun-01"
      }
    ]
  ...
  "northeurope" = {
        ...
        route_tables = [
          { 
            ...
            routes = [
              ...
              {
                route_name             = "routeToHubUKS"
                address_prefix         = "10.64.0.0/24"
                next_hop_type          = "VirtualAppliance"
                next_hop_in_ip_address = "10.64.0.4"
              }
            ]
          },
          { 
    ...
    virtual_network_peerings = [
      ...
      },
      {
        ...
        spoke_virtual_network_name                 = "vnet-hub-cpl-cn-eun-01"
        hub_subscription_id                        = "aa2950c5-4c1e-41b7-ad10-38537bf033b1"
        hub_virtual_network_resource_group_name    = "rg-hub-cpl-cn-uks-01"
        hub_virtual_network_name                   = "vnet-hub-cpl-cn-uks-01"
      }
    ]
    monitor_diagnostic_shared_settings = {
      log_analytics_workspace_subscription_id     = "9d34b6fd-76e7-41f3-8d91-33a1e9aa4488"
